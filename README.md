...
You need Gradle files, like in [Screen Operator](github.com/Android-PowerUser/ScreenOperator). You can copy them or get these from Android Studio. A fork have probably already the files.
