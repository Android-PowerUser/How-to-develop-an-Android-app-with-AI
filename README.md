...
> ⚠️ **IMPORTANT:** Always use the planning feature in Jules (rocket icon)! AI instructions surprisingly often implement something different than intended. Planning significantly improves LM results.
...
You need to copy the Gradle, Google and other file/s, except /app/ from [Screen Operator](https://github.com/Android-PowerUser/ScreenOperator) or maybe you can generate these automatically with Jules. A fork have probably already these files.
